...
export default function Terms() {
  return (
    <>
      <Helmet>
        <title>Terms of Service | Co-Create Innovation Hub</title>
        <meta name="description" content="Review the terms and conditions for using Co-Create Innovation Hub's services and facilities." />
        <link rel="canonical" href="https://cc-hub.com/terms" />
      </Helmet>
